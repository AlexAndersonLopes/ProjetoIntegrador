...
public class RelatorioVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Devolução R$:");

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("Total Bruto R$:");

        labelDevolucao.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        labelDevolucao.setForeground(new java.awt.Color(153, 0, 0));
        labelDevolucao.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);

        labelBruto.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        labelBruto.setForeground(new java.awt.Color(0, 0, 0));
        labelBruto.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(labelBruto, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)
                    .addComponent(labelDevolucao, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(labelBruto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(labelDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            BigDecimal bruto = dao.obterTotalPagamentos(dataInicial, dataFinal, usua, tipoPagamento);
            ...
            BigDecimal totalBruto = bruto.subtract(total);

            if (totalBruto.compareTo(BigDecimal.ZERO) < 0 && comboPagamento.getSelectedItem().equals("Todos")) {
                labelDevolucao.setText(String.valueOf(totalBruto));
                labelDevolucao.setFont(new Font(labelDevolucao.getFont().getName(), Font.PLAIN, 20));
                labelDevolucao.setToolTipText(null);
                labelBruto.setText(String.valueOf(total));
                txtTotal.setText(String.valueOf(bruto));
            } else {
                labelDevolucao.setText("?");
                labelDevolucao.setFont(new Font(labelDevolucao.getFont().getName(), Font.BOLD, 24));
                labelDevolucao.setToolTipText("<html>Só é possivel mostrar se há Devolução <br>Se o tipo de pagamento for TODOS</html>");
                labelBruto.setText(String.valueOf(total));
